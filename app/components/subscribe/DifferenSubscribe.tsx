...
export default function Differentiator() {
  return (
    <section className="bg-[#422646] py-16 md:py-20">
      <div className="max-w-6xl mx-auto px-4 md:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-12">
          ...
          <div className="border border-[#d876ac] rounded-card p-7 bg-white/5">
            <h3 className="font-body text-sm font-semibold tracking-wide text-[#d876ac] mb-5">
              SOM TAM MARKET
            </h3>
            <ul className="space-y-4">
              {stmBullets.map((b) => (
                <li key={b} className="flex items-start gap-3">
                  <CheckIcon className="w-5 h-5 text-[#d876ac] shrink-0 mt-0.5" />
                  <span className="font-body text-sm text-white" style={{ lineHeight: 1.7 }}>
                    {b}
                  </span>
                </li>
              ))}
